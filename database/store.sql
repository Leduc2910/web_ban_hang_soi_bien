...
VALUES (1, 'Rau-củ-quả',
        'https://lh3.googleusercontent.com/Tbx6y7pI3TBXLszBKa_UDfPXNWKufgrNzmalmQKEHHJ_88UWAyWQeXHPIu34GlAT1uzvNbaj26M9BPDmotQHMVZRMQ2rw1heiA=rw'),
       (2, 'Thịt tươi sống',
        'https://lh3.googleusercontent.com/F3vKdxaVPmRAnQha3-4U6dttbxoKG6efdBwZn56rrp4AkrbiIaZF_F1O1K4QBm_JpQ8s9QqO0w4fBLi0_gKbQrP9SFQrSASS=rw'),
       (3, 'Thủy hải sản',
        'https://lh3.googleusercontent.com/EVymB6noxcgaWo-OL7nrV2aTW0fb-9KhA0x7YNF8fFmStgSMGgtpHgKNTNnytkuSdjJzDEeMyLx-f7eHdl4Uc8O5Oo3yvpFZ'),
       (4, 'Hàng đông lạnh',
        'https://lh3.googleusercontent.com/5Dd8bolWxWh0tEtpT62IyZeugwutTQuTNAJSNQgRrAhRmCvMC_dJ1jjXKAUEHxoF10HyYXu-cLPLlFaQ1Z8aviCF11s4OpB9'),
       (5, 'Thực phẩm khô',
        'https://lh3.googleusercontent.com/dhwUTi4n9xpR7kM28yoTLgmQleKxiXZVohyvL4gLrDyM0AVX9XPx9Gh6_KmFvwHex34yh5AIvC_5cgmqawt9hZGjInjs0ug'),
       (6, 'Kem - bơ - sữa - trứng',
        'https://lh3.googleusercontent.com/78IW4RsG90dZGmhxjVPz0dDOawSHK6-lbRL_phE3MIVAUL_v0O853CD34oHJQszXebbWQ3i2PD_WRIWZ6mZWpFpWTsjtFj2l');
