    ...
    <div class="main">
        ...
        <div class="content">
            <div class="row row-fix">
                <div class="col-12">
                    <h1><span style="font-weight: normal; font-size: smaller">Detail</span> Order</h1>
                    <hr>
                </div>
                <div class="col-12 mt-3">
                        <div class="form-row">
                            <div class="form-group col-md-7">
                                <div class="wrapper-orderitem" style="max-height: 620px; overflow: auto">
                                    <hr style="width: 100%">
                            ...
                            <div class="form-group col-md-5">
                                <div class="col-sm-12 detail-container">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            <fmt:formatNumber value="${orderDetail.totalPrice}" type="currency"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <a href="/admin?action=managerOrder" class="btn btn-secondary">Back to list</a>
                            </div>
                        </div>
                </div>
            </div>
