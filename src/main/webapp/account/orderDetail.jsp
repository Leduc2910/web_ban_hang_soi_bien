    ...
    <div class="wrapper-acc">
      <div class="acc-sidebar-left">
        <div class="info-customer">
          <span class="img-acc"><i class="fa-regular fa-circle-user"></i></span>
      ...
      <div class="order-middle">
        <h6 style="font-size: 20px; font-weight: bold">Thông tin đơn hàng</h6>
        <div class="order-detail">
          <div class="product-order-detail">
            <img src="https://lh3.googleusercontent.com/qeT9EG7BmBj9_6ToB0gezKZgTyUN8OasNa26XvY-QBstDDv_664qkX8a2UbvKumhiQGUDiXIAG9i5QyLOZqTvMeBbbJtX5r4=w230-rw"
                 alt="">
            <div class="order-list">
              <span style="font-size: 14px; font-weight: 600">Bắp hoa bò</span>
              <span style="font-size: 12px; opacity: 50%">Số lượng: 1</span>
              <span style="font-weight: bold">459.000 đ</span>
            </div>
          </div>
          <div class="product-order-detail">
            <img src="https://lh3.googleusercontent.com/qeT9EG7BmBj9_6ToB0gezKZgTyUN8OasNa26XvY-QBstDDv_664qkX8a2UbvKumhiQGUDiXIAG9i5QyLOZqTvMeBbbJtX5r4=w230-rw"
      ...
      <div class="order-sidebar-right">
        <h6 style="font-size: 20px; font-weight: bold">Thông tin địa chỉ người nhận</h6>
        <div class="customer-address">
          <div class="customer-info">
            <div class="customer-name">
              <h6><span style="color: red">*</span> Họ Tên</h6>
              <input type="text">
            </div>
            <div class="customer-phoneNumber">
              <h6><span style="color: red">*</span> Số điện thoại</h6>
              <input type="text">
            </div>
          </div>
          <div class="address-detail">
            <h6 style="margin: 0 0"><span style="color: red">*</span> Địa chỉ giao hàng</h6>
            <textarea></textarea>
          </div>
          <div class="order-note">
            <h6 style="margin: 0 0"><span style="color: red">*</span> Ghi chú đơn hàng</h6>
            <textarea></textarea>
          </div>
        </div>
      </div>
